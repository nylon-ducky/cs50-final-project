...
function draw() {
  ...
  //
  //rand = floor(random(0, cells.length));
  //console.log(rand);
  //console.log(current);
  //
  ...
  else if (stack.length > 0 && stack.length < cells.length)
  {
    ...
    //console.log(stack[rand]);
    if (stack[rand].checkNeighbors()) {
      current = stack[rand]//.splice(rand-1,rand);
      console.log("rand" + stack.length);
    }else{
      current = stack.pop();
      console.log("norm rand" + stack.length);
    }
